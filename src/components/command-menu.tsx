...
const CommandMenu = ({ links }: Props) => {
  ...
  return (
    <>
      <p className="border-t-muted bg-secondary text-muted-foreground fixed bottom-0 left-0 right-0 hidden border-t p-1 text-center text-sm xl:block dark:text-white print:hidden">
        Press{' '}
