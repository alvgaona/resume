...
const CommandMenu = ({ links }: Props) => {
  ...
  return (
    <>
      <p className="fixed bottom-0 left-0 right-0 hidden border-t border-t-muted bg-secondary p-1 text-center text-sm text-muted-foreground dark:text-white xl:block print:hidden">
        Press{" "}
