...
const CommandMenu = ({ links }: Props) => {
  ...
  return (
    <>
      <p className="text-muted-foregroun fixed bottom-0 left-0 right-0 hidden border-t border-t-muted bg-dark-clay p-1 text-center text-sm text-white print:hidden xl:block">
        Press{' '}
