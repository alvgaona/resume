...
export const data: ResumeData = {
    ...
    skills: [
        ...
        // },
        {
            break: false,
            category: 'Other',
            badges: ['Teamwork', 'Ownership', 'Communication', 'Leadership', 'Self-motivated', 'Public Speaking'],
        },
    ],
    projects: [
        {
            ...
            tags: ['PyTorch', 'Jupyter', 'Python', 'Computer Vision', 'Hyperparameters'],
            details: [
        ...
        },
        {
            ...
            tags: ['C++', 'Python', 'ROS/ROS2', 'Sensor Fusion', 'LiDAR', 'Radar', 'Cameras'],
            details: [
        ...
        },
        {
            ...
            tags: ['C++', 'PX4', 'NVIDIA® Jetson', 'QGroundControl', 'Mavlink', 'ROS', 'Gazebo'],
            details: [
        ...
        },
        {
            ...
            tags: ['Segmentation', 'C/C++', 'Python', 'State Estimation', 'Q-Learning'],
            details: [
        ...
        },
        {
            ...
            tags: ['Kalman', 'Pinhole Model', 'C++17', 'Feature Extraction', 'RANSAC'],
            details: [
